...
<div class="container">
    <form class="form py-5 row g-3 justify-content-center" action="{{route('admin.dishes.update', $dish)}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="col-md-12">
        ...
        <div class="col-md-12">
            ...
            <input  class="form-control" type="number" step="0.1" name="price" id="price" required value="{{$dish->price}}">
        </div>
        <div class="col-md-12">
